/* ftd-selector-d.js - runtime extracted from the inline <script> so the browser
   can cache it. All merchant-editable values arrive via the config queue
   (window.__ftdDQueue) pushed by the section/block's inline script. */
(function () {
  function run(C) {
  var SID = C.SID;
  ...
  window.__ftdDMain = function () {
    ...
    while (q.length) { var c = q.shift(); try { run(c); } catch (e) { console.error('ftd-selector-d.js', e); } }
  };
